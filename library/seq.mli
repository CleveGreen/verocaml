...
val axiom_length_domain : 'a t -> unit [@@verocaml.proof]
val axiom_init_length : int -> (int -> 'a) -> unit [@@verocaml.proof]
val axiom_init_get : int -> (int -> 'a) -> int -> unit [@@verocaml.proof]
val axiom_push_length : 'a t -> 'a -> unit [@@verocaml.proof]
val axiom_push_get_last : 'a t -> 'a -> unit [@@verocaml.proof]
val axiom_push_get_old : 'a t -> 'a -> int -> unit [@@verocaml.proof]
val axiom_update_length : 'a t -> int -> 'a -> unit [@@verocaml.proof]
val axiom_update_get_same : 'a t -> int -> 'a -> unit [@@verocaml.proof]
val axiom_update_get_other : 'a t -> int -> 'a -> int -> unit
[@@verocaml.proof]
val axiom_subrange_length : 'a t -> int -> int -> unit [@@verocaml.proof]
val axiom_subrange_get : 'a t -> int -> int -> int -> unit
[@@verocaml.proof]
val axiom_append_length : 'a t -> 'a t -> unit [@@verocaml.proof]
